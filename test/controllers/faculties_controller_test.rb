...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { Email: @faculty.Email, Firstname: @faculty.Firstname, Lastname: @faculty.Lastname, Phone: @faculty.Phone, Ttitle: @faculty.Ttitle } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { Email: @faculty.Email, Firstname: @faculty.Firstname, Lastname: @faculty.Lastname, Phone: @faculty.Phone, Ttitle: @faculty.Ttitle } }
